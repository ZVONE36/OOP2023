...
#ODABIR TELEFONA
    ...
    for m, telefon in enumerate(telefoni, start=1):
        print(f"\t{m}. {telefon['broj']}")
...
#ODABIR ARTIKLA
    ...
    prodaja["telefon"] = telefoni[odabrani_telefon]
...
for i, prodaja in enumerate(prodaje, start=1):
    ...
    print(f'\tTelefon: {prodaja["telefon"]["proizvođač"]}')
